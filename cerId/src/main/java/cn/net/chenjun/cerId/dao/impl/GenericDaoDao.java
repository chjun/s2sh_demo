...
import cn.net.chenjun.cerId.dao.GenericDao;

public class GenericDaoDao<T, PK extends Serializable> extends
		HibernateDaoSupport implements GenericDao<T, PK> {

	private Class<T> persistentClass;

	protected final Log log = LogFactory.getLog(GenericDaoDao.class);

	public GenericDaoDao() {
	}
	 ...
	 */
	public GenericDaoDao(final Class<T> persistentClass) {
